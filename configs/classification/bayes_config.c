#include "configs\classification\bayes_config.h"
...
float INV_COVS[NUM_CLASSES][NUM_FEATURES * NUM_FEATURES] = {{{ 1.40938779,-0.04605597},
  {-0.04605597, 0.26668508}},

 {{ 5.59177271,-0.11959348},
  {-0.11959348, 0.98673676}}};
